...
export default function TrainScheduleList() {
  ...
  useEffect(() => {
    ...
    if (userId) {
      axios
        .get(`https://cse471-project-production.up.railway.app/api/users/${userId}`)
        .then((res) => {
      ...
      axios
        .get(`https://cse471-project-production.up.railway.app/api/users/${userId}/favorite-routes`)
        .then((res) => {
  ...
  const fetchSchedules = async () => {
    try {
      const res = await axios.get("https://cse471-project-production.up.railway.app/api/schedules");
  ...
  const handleBooking = async (train) => {
    ...
    try {
      ...
      try {
        const studentRes = await axios.get(`https://cse471-project-production.up.railway.app/api/student-verification/status/${userId}`);
  ...
  const toggleFavoriteRoute = async (train) => {
    ...
    try {
      ...
      if (isFavorite) {
        ...
        await axios.delete(`https://cse471-project-production.up.railway.app/api/users/${userId}/favorite-routes`, {
        ...
        const response = await axios.post(`https://cse471-project-production.up.railway.app/api/users/${userId}/favorite-routes`, routeData);
