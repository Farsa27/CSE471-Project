...
const MyStationHazardReports = () => {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      ...
      try {
        const res = await fetch(`http://localhost:5000|https://cse471-project-backend-51jt.onrender.com/api/reports/station-hazard/${user._id}`);
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                        {report.media.map((file, idx) => (
                          <a
                            key={idx}
                            href={`http://localhost:5000|https://cse471-project-backend-51jt.onrender.com${file}`}
                            target="_blank"
